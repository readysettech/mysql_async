...
use mysql_common::{
    ...
    io::ParseBuf,
    packets::{
        session_state_change::SessionStateChange, AuthPlugin, AuthSwitchRequest, CommonOkPacket, ErrPacket, HandshakePacket,
...
mod test {
    ...
    use crate::{
        from_row, params, prelude::*, test_misc::get_opts, ChangeUserOpts, Conn, Error, OptsBuilder, Pool, ServerError, TxOpts, Value, WhiteListFsHandler
    };
