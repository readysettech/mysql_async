...
use mysql_common::{
    ...
    packets::{
        ...
        OkPacketDeserializer, OldAuthSwitchRequest, OldEofPacket, ResultSetTerminator, SslRequest,
    },
    proto::MySerialize,
    row::Row,
};
...
mod test {
    ...
    use crate::{
        ...
        ChangeUserOpts, Conn, Error, OptsBuilder, Pool, TxOpts, Value, WhiteListFsHandler,
    };
